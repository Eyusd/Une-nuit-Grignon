...
/// Declare Scenes
	...
	this.draguep2= function() {
		...
		this.collection = [ new Img("pullup",0,"pullup",0,0,100,900/16),
							...
							["évoquer le feu", function() {supprime("pauline");gui.textBox(["[Sasha]", "C’est moi où le feu est aussi chaud que l’atmosphère entre nous ?"], [], function() {scene.collection.push(new Img("pauline3",5,"pauline3",30,20,70,50));gui.stupidity +=20; gui.textBox(["[Pauline]", "Alors j’en perds mes mots"], [], function() {scene.unload("draguep2"); scene.draguep3()})})}],
							["la comparer aux étoiles", function() {supprime("pauline");gui.textBox(["[Sasha]", "Tu es aussi rayonnante que les étoiles", "de la constellation du dragon."], [], function() {scene.collection.push(new Img("pauline2",5,"pauline2",10,10,85,70));gui.stupidity +=0; gui.textBox(["[Pauline]", "Oh ! Je suis hyper touchée"], [], function() {scene.unload("draguep2"); scene.draguep3()})})}],
							["t'es bonne", function() {supprime("pauline");gui.textBox(["[Sasha]", "Vas y t'es tellement bonne que", "je t'échangerais contre ma daronne"], [], function() {scene.collection.push(new Img("pauline5",5,"pauline5",30,20,65,50));gui.stupidity +=80; gui.textBox(["[Pauline", "J’me casse, sans cordialité aucune"], [], function() {scene.unload("draguep2"); scene.draguep3()})})}],
	...
	this.draguep3= function() {
		...
		this.collection = [ new Img("pullup",0,"pullup",0,0,100,900/16),
							...
							["raconter ses rêves", function() {supprime("pauline");gui.textBox(["[Sasha]", " On m’a toujours dit de suivre mes rêves,", "alors ce soir je te suis."], [], function() {gui.stupidity +=40; gui.textBox(["*Pauline a pris la fuite*"], [], function() {gui.textBox(["[Pauline]", "BYE, SANS CORDIALITÉ AUCUNE"], [], function() {scene.unload("draguep3"); scene.chateau()})})})}],
	...
	this.draguej1= function() {
		...
		this.collection = [ new Img("pullup",0,"pullup",0,0,100,900/16),
							...
							["parler en anglais", function() {supprime("jimmy");gui.textBox(["[Sasha]", " May I kiss you on your buttcheeks?"], [], function() {scene.collection.push(new Img("jimmy3",5,"jimmy3",20,0,70,90)),gui.stupidity +=40; gui.textBox(["[Jimmy]","Ah..bah non ça va pas être possible"], [], function() {scene.unload("draguej1"); scene.draguej2()})})}],
							["proposer de réviser ensemble", function() {supprime("jimmy");gui.textBox(["[Sasha]", "Faut que je révise pour les partiels,", "tu me donnes un coup de main", "pour les TD  de repro?"], [], function() {scene.collection.push(new Img("jimmy2",5,"jimmy2",20,0,70,90));gui.stupidity +=20; gui.textBox(["[Jimmy]", "Ca faut le mériter mon chou"], [], function() {scene.unload("draguej1"); scene.draguej2()})})}],
							["être direct", function() {supprime("jimmy");gui.textBox(["[Sasha]", "Salut toi ! Je t’ai cherché des", "yeux pendant toute la soirée."], [], function() {scene.collection.push(new Img("jimmy1",5,"jimmy1",20,0,70,90));gui.stupidity +=0; gui.textBox(["[Jimmy]", "Oh c’est un peu creepy mais je suis flatté !"], [], function() {scene.unload("draguej1"); scene.draguej2()})})}],
							["parler de ses fantasmes", function() {supprime("jimmy");gui.textBox(["[Sasha]", "J’ai toujours rêvé de chevaucher un mouton."], [], function() {scene.collection.push(new Img("jimmy4",5,"jimmy4",20,0,70,90));gui.stupidity +=80; gui.textBox(["[Jimmy]", "Ah bah cool pour toi. A +"], [], function() {scene.unload("draguej1"); scene.draguej2()})})}],
							["demander l'heure", function() {supprime("jimmy");gui.textBox(["[Sasha]", "Excuse-moi t’aurais pas l’heure parce que", "depuis que je t’ai vu, j’ai perdu", "la notion du temps."], [], function() {scene.collection.push(new Img("jimmy2",5,"jimmy2",20,0,70,90));gui.stupidity +=10; gui.textBox(["[Jimmy]", "Ah… me voilà gêné "], [], function() {scene.unload("draguej1"); scene.draguej2()})})}]])} ),
						];
		this.sort()
		}
	}
	...
	this.draguej2= function() {
		...
		this.collection = [ new Img("pullup",0,"pullup",0,0,100,900/16),
							...
							["parler en anglais", function() {supprime("jimmy");gui.textBox(["[Sasha]", " May I kiss you on your buttcheeks?"], [], function() {scene.collection.push(new Img("jimmy3",5,"jimmy3",20,0,70,90)),gui.stupidity +=40; gui.textBox(["[Jimmy]","Ah..bah non ça va pas être possible"], [], function() {scene.unload("draguej2"); scene.draguej3()})})}],
							["proposer de réviser ensemble", function() {supprime("jimmy");gui.textBox(["[Sasha]", "Faut que je révise pour les partiels,", "tu me donnes un coup de main", "pour les TD  de repro?"], [], function() {scene.collection.push(new Img("jimmy2",5,"jimmy2",20,0,70,90));gui.stupidity +=20; gui.textBox(["[Jimmy]", "Ca faut le mériter mon chou"], [], function() {scene.unload("draguej2"); scene.draguej3()})})}],
							["être direct", function() {supprime("jimmy");gui.textBox(["[Sasha]", "Salut toi ! Je t’ai cherché des", "yeux pendant toute la soirée."], [], function() {scene.collection.push(new Img("jimmy1",5,"jimmy1",20,0,70,90));gui.stupidity +=0; gui.textBox(["[Jimmy]", "Oh c’est un peu creepy mais je suis flatté !"], [], function() {scene.unload("draguej2"); scene.draguej3()})})}],
							["parler de ses fantasmes", function() {supprime("jimmy");gui.textBox(["[Sasha]", "J’ai toujours rêvé de chevaucher un mouton."], [], function() {scene.collection.push(new Img("jimmy4",5,"jimmy4",20,0,70,90));gui.stupidity +=80; gui.textBox(["[Jimmy]", "Ah bah cool pour toi. A +"], [], function() {scene.unload("draguej2"); scene.draguej3()})})}],
							["demander l'heure", function() {supprime("jimmy");gui.textBox(["[Sasha]", "Excuse-moi t’aurais pas l’heure parce que", "depuis que je t’ai vu, j’ai perdu", "la notion du temps."], [], function() {scene.collection.push(new Img("jimmy2",5,"jimmy2",20,0,70,90));gui.stupidity +=10; gui.textBox(["[Jimmy]", "Ah… me voilà gêné "], [], function() {scene.unload("draguej2"); scene.draguej3()})})}]])} ),
						];
		this.sort()
		}
	}
	...
	this.draguej3= function() {
		...
		this.collection = [ new Img("pullup",0,"pullup",0,0,100,900/16),
							...
							["demander l'heure", function() {supprime("jimmy");gui.textBox(["[Sasha]", "Excuse-moi t’aurais pas l’heure parce que", "depuis que je t’ai vu, j’ai perdu", "la notion du temps."], [], function() {scene.collection.push(new Img("jimmy2",5,"jimmy2",20,0,70,90));gui.stupidity +=10; gui.textBox(["[Jimmy]", "Ah… me voilà gêné "], [], function() {gui.textBox(["[Jimmy]"], ["[Jimmy]","Bisous ! Passe une soirée !"], function() {scene.unload("draguej3"); scene.chateau()})})})}]])} ),
						];
		this.sort()
		}
	}
	...
	this.U3= function() {
		...
		this.collection = [ new Img("U",0,"U",0,0,100,900/16),
							new Button("vgastro1",2,"Vide1",0,0,100,900/16,infini,function () {gui.textBox(["[Sasha]","Définitivement, cette soirée n’a eu aucun sens." ], [], function () {gui.textBox(["[Auriane]","Bon Sasha, maintenant plus d'excuses,", "tu viens m’aider pour le pain." ], [], function() {gui.textBox(["[Sasha]","Bon ok j’arrive." ], [], function() {scene.unload("U3"); scene.gastro1()})})})} ),
							];
		this.sort()
		}
	}
