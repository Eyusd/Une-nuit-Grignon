...
/// Declare Scenes
	...
	this.combat11= function() {
		...
		this.collection = [ new Img("foret5",0,"foret5",0,0,100,900/16),
							new Button("agression",2,"Vide1",0,0,100,900/16,infini,function () {gui.textBox(["[Sasha]","*tousse en sortant du Ru de Gally*" ], ["Sasha93"], function () {gui.textBox(["[???]"," A L’ATTAAAAAQUE !" ], ["Guillaume1"], function () {scene.unload("combat11"); scene.combat12()}  ) })})];
		this.sort()
		}
	}
	...
	this.gastro3= function() {
		...
		this.collection = [ new Img("gastro",0,"gastro",0,0,100,900/16),
							new Button("vgrange1",2,"lumiere",10,80,5,5,infini,function () {gui.textBox(["[Sasha]","Tout laisse penser que je trouverai plus", "d’indices en me rendant à la grange." ], ["Sasha94"], function() {scene.unload("gastro3"); scene.grange1()} )}),
							];
		this.sort()
		}
	}
	...
	this.pullup2= function() {
		...
		this.collection = [ new Img("pullup",0,"pullup",0,0,100,900/16),
							...
							["Pauline", function() {gui.textBox(["C'est parti!"], [], function() {scene.unload("pullup2"); scene.draguep1()})}],
							["Jimmy", function() {gui.textBox(["C'est parti!"], [], function() {scene.unload("pullup2"); scene.draguej1()})}]] )})})];
		this.sort()
		}
	}
	...
	this.draguep2= function() {
		...
		this.collection = [ new Img("pullup",0,"pullup",0,0,100,900/16),
							...
							["t'es bonne", function() {supprime("pauline");gui.textBox(["[Sasha]", "Vas y t'es tellement bonne que", "je t'échangerais contre ma daronne"], [], function() {scene.collection.push(new Img("pauline5",5,"pauline5",30,20,65,50));gui.stupidity +=80; gui.textBox(["[Pauline", "J’me casse, sans cordialité aucune"], ["Pauline4"], function() {scene.unload("draguep2"); scene.draguep3()})})}],
	...
	this.draguep3= function() {
		...
		this.collection = [ new Img("pullup",0,"pullup",0,0,100,900/16),
							...
							["raconter ses rêves", function() {supprime("pauline");gui.textBox(["[Sasha]", " On m’a toujours dit de suivre mes rêves,", "alors ce soir je te suis."], [], function() {gui.stupidity +=40; gui.textBox(["*Pauline a pris la fuite*"], [], function() {gui.textBox(["[Pauline]", "BYE, SANS CORDIALITÉ AUCUNE"], ["Pauline4"], function() {scene.unload("draguep3"); scene.chateau()})})})}],
							["évoquer le feu", function() {supprime("pauline");gui.textBox(["[Sasha]", "C’est moi où le feu est aussi chaud que l’atmosphère entre nous ?"], [], function() {scene.collection.push(new Img("pauline3",5,"pauline3",30,20,70,50));gui.stupidity +=20; gui.textBox(["[Pauline]", "Alors j’en perds mes mots"], ["Pauline3"], function() {gui.textBox(["[Pauline]", "Belle soirée et belle nuit à toi"], ["Pauline5"], function() {scene.unload("draguep3"); scene.chateau()})})})}],
							["la comparer aux étoiles", function() {supprime("pauline");gui.textBox(["[Sasha]", "Tu es aussi rayonnante que les étoiles", "de la constellation du dragon."], [], function() {scene.collection.push(new Img("pauline2",5,"pauline2",10,10,85,70));gui.stupidity +=0; gui.textBox(["[Pauline]", "Oh ! Je suis hyper touchée"], ["Pauline1"], function() {gui.textBox(["[Pauline]", "Belle soirée et belle nuit à toi"], ["Pauline5"], function() {scene.unload("draguep3"); scene.chateau()})})})}],
							["t'es bonne", function() {supprime("pauline");gui.textBox(["[Sasha]", "Vas y t'es tellement bonne que", "je t'échangerais contre ma daronne"], [], function() {scene.collection.push(new Img("pauline5",5,"pauline5",30,20,65,50));gui.stupidity +=80; gui.textBox(["[Pauline]", "J’me casse, sans cordialité aucune"], ["Pauline4"], function() {gui.textBox(["[Pauline]", "BYE, SANS CORDIALITÉ AUCUNE"], ["Pauline4"], function() {scene.unload("draguep3"); scene.chateau()})})})}],
	...
	this.eau2= function() {
		...
		this.collection = [ new Img("eau2",0,"eau2",0,0,100,900/16),
							new Button("venigmeetoile",2,"Vide1",0,0,100,900/16,infini,function () {gui.textBox(["[Camille]","Oups c'est moi pardon" ], ["Camille14"], function() {gui.choicesBox([["[Sasha]","Je me demande qui insiste autant pour lui parler…"], 
	...
	this.enigmeetoile= function() {
		...
		this.collection = [ new Img("eau2",0,"eau2",0,0,100,900/16),
							...
							new Collectible("croix", 7, "croix",8,10,8,8),
							new Collectible("croix", 7, "croix",8,15,8,8),
							new Collectible("croix", 7, "croix",8,20,8,8),
							...
							new Button("valider",3,"valider", 25,60,5,5, infini, function () {var ar=[null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null];
								for (i=0; i<scene.collection.length; i++) {
									var elt= scene.collection[i];
									if (elt.id=="ch3st01") {
										if (elt.slot==null) {
