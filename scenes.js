...
/// Declare Scenes
	...
	this.pullup1= function() {
		...
		this.collection = [ new Img("pullup",0,"pullup",0,0,100,900/16),
							...
							new Button("pullup1",2,"lumiere",65,30,5,5,infini,function () {gui.playsound("Gasolina");gui.stupidity +=30; supprime("pullup1"); gui.textBox(["Pull-uuuuuuuuuuuuup !" ] ,["Pullup"])} ),
	...
	this.combat21= function() {
		...
		this.collection = [ new Img("sa3",0,"sa3",0,0,100,900/16),
							...
							gui.textBox(["M.Cenfroque utilise 'BBCOLLAB'"], [], function () {gui.playsound("notif");
