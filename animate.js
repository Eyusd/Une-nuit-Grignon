...
window.addEventListener('load', function () {
	loadingscreen = false; scene.collection.push(new Button("startingbutton",100,"startbutton",45,67,10,5,100000,function () 
		{scene.unload("loadingscreen"); gui.show = true; scene.foret1(); gui.textBox(["[Sasha]","*baillement* Hmm ? Mais qu’est-ce que je fous là ?","Pourquoi je suis devant ma chambre?"," Je devrais peut-être rentrer."]);}))
  })
